...
- Minecraft 1.26.40-1.26.43向け旧プロトコルアダプタの常時登録
  - protocol ID 2168では旧persona piece typeを双方向変換し、1.26.45のprotocol ID 2169はgophertunnel標準実装で処理します。
  - 同じprotocol ID 2168でwire形式が異なる1.26.44は、ログイン時の`GameVersion`を確認して明示的に拒否します。
